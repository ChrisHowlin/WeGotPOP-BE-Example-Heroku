...
It's perfectly fine to re-use this definition in the WeGotPOP-BE-Example application,
though.
...
from wegotpopbeexample.model import DeclarativeBase, metadata, DBSession
